        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customs_Drink_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drink",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customs_Ingredient_IngredientId",
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 3, "Sprite", 1.5 },
                    { 4, "Japanese Green Tea", 2.2000000000000002 },
                    { 5, "Ice Lemon Tea", 2.0 },
                    { 2, "Coke Zero", 1.3 },
                    { 1, "Coke", 1.2 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Ingredient",
                columns: new[] { "Id", "CustomId", "Name", "Price" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Meals",
                columns: new[] { "Id", "Drink", "Food", "Price" },
                values: new object[,]
                {
                    { 1, "Coke Zero", "Salmon Bowl", 10.5 },
                    { 2, "Coke", "Tuna Bowl", 11.199999999999999 },
                    { 3, "Ice Lemon Tea", "Swordfish Bowl", 12.0 },
                    { 4, "Sprite", "Oriental Bowl (Salmon, Tuna, Swordfish)", 15.0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customs_DrinkId",
                table: "Customs",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_Customs_IngredientId",
                table: "Customs",
                column: "IngredientId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Ingredient_Customs_CustomId",
                table: "Ingredient",
                column: "CustomId",
                principalTable: "Customs",
                principalColumn: "Id",
